        ...
        <div className="header">
         ...
         <div className="char-card-sub">
          ...
          <div className="detailsGroup">
            <div className="personalDetails">MGLT - {detailList && detailList.MGLT}</div>
          ...
          <div className="personalDetails">Starship Class - {detailList && detailList.starship_class}</div>
          </div>
        </div>
        </div>
        {detailList && 
